...
public class JdbcAuthorizationCodeServices extends RandomValueAuthorizationCodeServices {
    ...
    private static final String DEFAULT_SELECT_STATEMENT = "select code, authentication from t_oauth_code where code = ?";
    private static final String DEFAULT_INSERT_STATEMENT = "insert into t_oauth_code (code, authentication) values (?, ?)";
    private static final String DEFAULT_DELETE_STATEMENT = "delete from t_oauth_code where code = ?";
